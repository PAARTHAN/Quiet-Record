...
def build_emergency_report(user: User, contacts: list[TrustedContact], db: Session) -> str:
    ...
    sections: list[str] = []
    sections.append("GALAXIO - EMERGENCY INFORMATION REPORT")
    sections.append("")
    ...
    sections.append("-" * 88)
    sections.append("This report was automatically generated by the Galaxio system.")
...
def build_sms_summary(user: User, db: Session, recipient_name: str) -> str:
    ...
    summary = [
        ...
        "Full report in your email. - Galaxio"
    ]
    return "\n".join(summary)
